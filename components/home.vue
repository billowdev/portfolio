		...
		<div class="home_container container grid">
			<div class="home_content grid">
				<div class="home_social">
					<a href="https://www.linkedin.com/in/lacakira/" target="_blank" class="home_social">
						<i class="uil uil-linkedin-alt home_social-icon"></i>
					</a>

					<!-- <a href="https://web.facebook.com/lacakkarapon" target="_blank" class="home_social">
						<i class="uil uil-facebook-f home_social-icon"></i>
					</a> -->

					<a href="https://www.github.com/lacakira" target="_blank" class="home_social">
				...
				<div class="home_img">
					<svg class="home_blob" viewBox="0 0 200 187" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
						...
						<g mask="url(#mask0)">
							...
							<image class="home_blob-img" x="-24" y="15" xlink:href="./assets/images/profile_lacakp.webp"/>
